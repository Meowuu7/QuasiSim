...
from ControlVAECore.Model.pointnet2_ssg_cls import PointNet2ClassificationSSG
...
class PointNet2SemSegSSG(PointNet2ClassificationSSG):
    def _build_model(self):
        ...
        self.SA_modules.append(
            PointnetSAModule(
                npoint=1024, ## points and 1024 ## for each object point -> use the network for per-point feature extraction? ### per-
                radius=0.1,
                nsample=32,
                mlp=[6, 32, 32, 64],
        ...
        self.fc_lyaer = nn.Sequential(
            ...
            nn.ReLU(True),
            nn.Dropout(0.5),
            nn.Conv1d(128, out_feat, kernel_size=1),
        )
    ...
    def forward(self, pointcloud):
        ...
        """
        xyz, features = self._break_up_pc(pointcloud) # B x N x ()
