...
if __name__ == '__main__':
    ...
    args.image_sv_folder = f"./save_res/goal_optimize_model_{pure_model_name}_obj_type_{args.obj_type}_nfr_{args.n_frames}_view_divide_{args.view_divide}_n_views_{args.n_views}_three_planes_{args.use_three_planes}"
