...
if __name__ == '__main__':
    ...
    # /data2/datasets/diffsim/diffredmax/save_res/goal_optimize_model_hand_sphere_test_obj_type_active_passive_nfr_10_view_divide_0.5_n_views_7_three_planes_False_recon_dvgo_new_Nposes_7_cam_configs_routine_2_tag_light_color
    ...
    reconstructor.load_target_rendering_depth(target_depth_img_sv_fn) # load target rendering img #
    
    
    # initial_radius = 0.2047
    # ### config fn ###
    # conf_fn = "/home/xueyi/diffsim/DiffHand/assets/hand_sphere_only_hand_test_with_obj_wopt.xml"
    # load_utils.dump_robot_configurations(initial_radius, conf_fn) # 
    ...
    # sim.reset(backward_flag = args.gradient) 

    # reconstructor.passive_robot.
    ...
    ### optimize the target grid space ###
    ...
    # if len(args.optimized_u_fn) > 0: # len(args.) # #  #
    ...
    def loss_and_grad_ref_states(u): ## loss and grad ref states
        global i_iter, args, model_path, rendering_timestep # load the rgb file #
