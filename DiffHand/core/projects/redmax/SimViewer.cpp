...
void SimViewer::initialize() {
    ...
    option.SetVectorOption("camera pos", _sim->_viewer_options->_camera_pos.cast<float>()); // zoom spped //
    ...
    option.SetFloatOption("camera zoom speed", 0.5f); // and a general framework for the rendering process //
    ...
    viewer.Initialize(option); // viwer keyboard //
