...
void ForceGeneralPrimitiveContact::computeForce(std::vector<Contact> &contacts, VectorX& fm, bool verbose) {
    Matrix3 R1 = _contact_body->_E_0i.topLeftCorner(3, 3); // R1 
    ...
    for (int i = 0;i < contacts.size();i++) {
        ...
        Vector3 xw1 = R1 * xi1 + p1; // skew xi1; //
        ...
        Vector6 ni1 = GTRT1 * n; // joint damping //
        MatrixX GTRT2 = Gamma2.transpose() * R2.transpose();
        Vector6 ni2 = GTRT2 * n; // gamma 1 and gamma 2; GTRT2 //
