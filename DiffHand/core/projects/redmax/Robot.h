...
public:
    ...
    // strategy 1 -> add the initial force and the discounting factor that varies across time //
    VectorX _initial_c_force;

    // strategy 2 -> add the previous force and the interpolation factor //
    VectorX _prev_c_force;
    VectorX _cur_c_force; 
