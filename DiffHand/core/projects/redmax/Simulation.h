...
public:
    ...
    // constructors
    Simulation(Options *options, std::string name = ""); // construct from options //
    Simulation(Options *options, ViewerOptions *viewer_options, std::string name = ""); // construct from options and vieweroptions //
    Simulation(std::string xml_file_path, bool verbose = false); // construct from xml //
    ...
    void init_viewer();
    bool advance_viewer_step(int num_steps); // advance viewer steps //
    void replay();

    // export simulation replay to a folder
    void export_replay(std::string folder); /// viewer step // replay //
